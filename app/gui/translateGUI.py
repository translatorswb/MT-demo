...
MT_API_URL = os.environ.get('MT_API_URL')
GAMAYUN_API_TOKEN = os.environ.get('API_TOKEN')
MAX_REQUEST_LENGTH = int(os.environ.get('MAX_REQUEST_LENGTH'))
...
async def form_post(request: Request):
    ...
    return templates.TemplateResponse('translate2.html', context={'request': request, 'api_languages':api_languages, 'api_models':api_models, 'src':src, 'tgt':tgt, 'source': message, 'text1': result, 'text2': '', 'disclaimer':disclaimer, 'maxlength':MAX_REQUEST_LENGTH})
